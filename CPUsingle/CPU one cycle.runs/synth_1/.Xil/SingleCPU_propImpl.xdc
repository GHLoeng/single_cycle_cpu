set_property SRC_FILE_INFO {cfile:{G:/Vivado/CPUsingle/CPU one cycle.srcs/constrs_1/new/SingleCPU.xdc} rfile:{../../../CPU one cycle.srcs/constrs_1/new/SingleCPU.xdc} id:1} [current_design]
